from text_metrics.utils import get_surprisal, init_tok_n_model
...
def main():
    ...
    for model_name in model_names:
        ...
        _ = get_surprisal(below_2048, tokenizer, model, model_name, context_stride=1625)
        _ = get_surprisal(over_2048, tokenizer, model, model_name, context_stride=1625)
        print("Didn't crash")
