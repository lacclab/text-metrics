# Creadit: https://github.com/tmalsburg/scanpath/blob/6984b604627555b03f1bad674361a9ee4014f2c0/scanpath/R/plot_scanpaths.R
...
plot_scanpaths.2d <- function(d, terms) {
  ...
  p +
    ...
    ggplot2::facet_wrap(~ trial) +
    ggplot2::scale_size_area(name="Duration:", breaks=c(100, 200, 300, 400, 500), limits=c(0, 500))
